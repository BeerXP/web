					...
					<Container fluid>
						<Row>
							...
							<Col md='6'>
								...
								>
									<Card
										className='mb-3 text-dark card-border'
										inverse
										color='light'
									>
										<CardHeader>Header</CardHeader>
						...
						<Row>
							<Col md='6'>
								...
								>
									<Card className='main-card mb-3'>
										<CardHeader>
											<i className='header-icon lnr-bicycle icon-gradient bg-love-kiss'>
												{' '}
											</i>
											Header with Tabs
											<div className='btn-actions-pane-right actions-icon-btn'>
								...
								>
									<Card className='main-card mb-3'>
										<CardHeader>
											<i className='header-icon lnr-gift icon-gradient bg-mixed-hopes'>
												{' '}
											</i>
											Alternate Tabs
											<div className='btn-actions-pane-right actions-icon-btn'>
						...
						<Row>
							<Col md='12'>
								...
								>
									<Card
										className='mb-3 card-tabs text-white card-border'
										color='focus'
									>
										<Tabs
