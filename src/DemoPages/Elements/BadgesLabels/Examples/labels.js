							...
							<Col lg='6'>
								<Card className='main-card mb-3'>
									<CardBody>
										...
										<div className='mb-2 mr-2 badge badge-secondary'>
											Secondary
										</div>
										<div className='mb-2 mr-2 badge badge-success'>
											Success
										</div>
										<div className='mb-2 mr-2 badge badge-info'>
											Info
										</div>
										<div className='mb-2 mr-2 badge badge-warning'>
											Warning
										</div>
										<div className='mb-2 mr-2 badge badge-danger'>
											Danger
										</div>
										<div className='mb-2 mr-2 badge badge-focus'>
											Focus
										</div>
										<div className='mb-2 mr-2 badge badge-alternate'>
											Alt
										</div>
										<div className='mb-2 mr-2 badge badge-light'>
											Light
										</div>
										...
										<div className='mb-2 mr-2 badge badge-pill badge-focus'>
											Focus
										</div>
										<div className='mb-2 mr-2 badge badge-pill badge-alternate'>
											Alt
										</div>
										<div className='mb-2 mr-2 badge badge-pill badge-light'>
											Light
										</div>
										<div className='mb-2 mr-2 badge badge-pill badge-dark'>
											Dark
										</div>
										...
										<a
											href='#top'
											className='mb-2 mr-2 badge badge-info'
										>
											Info
										</a>
										<a
											href='#top'
											className='mb-2 mr-2 badge badge-warning'
										>
											Warning
										</a>
										<a
										...
										<a
											href='#top'
											className='mb-2 mr-2 badge badge-focus'
										>
											Focus
										</a>
										<a
											href='#top'
											className='mb-2 mr-2 badge badge-alternate'
										>
											Alt
										</a>
										<a
											href='#top'
											className='mb-2 mr-2 badge badge-light'
										>
											Light
										</a>
										<a
											href='#top'
											className='mb-2 mr-2 badge badge-dark'
										>
											Dark
										</a>
									</CardBody>
