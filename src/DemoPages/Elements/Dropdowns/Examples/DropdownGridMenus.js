						...
						<Row>
							<Col lg='6'>
										...
										<UncontrolledButtonDropdown>
											...
											<DropdownMenu>
												<Nav vertical>
													...
													<NavItem>
														<NavLink href='#'>
															<i className='nav-link-icon pe-7s-chat'>
																{' '}
															</i>
															<span>Chat</span>
															<div className='ml-auto badge badge-pill badge-info'>
													...
													<NavItem>
														<NavLink href='#'>
															<i className='nav-link-icon pe-7s-config'>
																{' '}
															</i>
															<span>
																Settings
													...
													<NavItem>
														<NavLink href='#'>
															<i className='nav-link-icon pe-7s-coffee'>
																{' '}
															</i>
															<span>
																Messages
													...
													<NavItem>
														<NavLink href='#'>
															<i className='nav-link-icon pe-7s-box2'>
																{' '}
															</i>
															<span>Logs</span>
														</NavLink>
								...
								<Card className='main-card mb-3'>
									<CardBody>
										<CardTitle>
											Extra Large Menu without Subtitles
										</CardTitle>
										<UncontrolledButtonDropdown>
											<DropdownToggle
												caret
						...
						<Row>
							<Col md='12'>
								<Card className='main-card mb-3'>
									<CardBody>
										<CardTitle>
											Dropdown Standard Menu with Headers
										</CardTitle>
										<UncontrolledButtonDropdown>
											<DropdownToggle
												caret
													...
													<Row className='no-gutters'>
														...
														<Col xl='4' sm='6'>
															<Button
																...
																color='secondary'
															>
																<i className='lnr-map btn-icon-wrapper'>
																	{' '}
																</i>
																Secondary
															</Button>
														...
														<Col xl='4' sm='6'>
															<Button
																...
																color='success'
															>
																<i className='lnr-music-note btn-icon-wrapper'>
																	{' '}
																</i>
																Success
															</Button>
