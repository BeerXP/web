							...
							<Card className='main-card mb-3'>
								<CardBody>
									...
									<Row className='text-center'>
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-primary'
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-secondary'
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-focus'
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-alternate'
												loading={this.state.expZoomOut}
												onClick={() =>
													this.toggle('expZoomOut')
												}
												data-style={ZOOM_OUT}
											>
												Zoom Out
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-light'
												loading={
													this.state.expSlideLeft
												}
												onClick={() =>
													this.toggle('expSlideLeft')
												}
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-dark'
												loading={
													this.state.expSlideRight
												}
												onClick={() =>
													this.toggle('expSlideRight')
												}
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-danger'
												loading={this.state.expSlideUp}
												onClick={() =>
													this.toggle('expSlideUp')
												}
												data-style={SLIDE_UP}
											>
												Slide Up
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-warning'
												loading={
													this.state.expSlideDown
												}
												onClick={() =>
													this.toggle('expSlideDown')
												}
									...
									<Row className='text-center'>
										...
										<Col md='3'>
											<LaddaButton
												className='mb-2 mr-2 btn btn-outline-info'
