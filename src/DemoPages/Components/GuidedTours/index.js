		...
		content: function DemoHelperComponent() {
			return (
				<div>
					...
					<Text color='#e5e5e5'>
						The{' '}
						<Tooltip data-tooltip='this helper ⬇'>
							tourist guide
						</Tooltip>{' '}
						could be dressed in any way, using custom components,
						styles and so on…
					</Text>
					<Text
						color='#373737'
		...
		content: function DemoHelperComponent() {
			return (
				<Text>
					...
					<br />
					In this case will try to stay in the{' '}
					<strong>left side</strong> if there is available space,
