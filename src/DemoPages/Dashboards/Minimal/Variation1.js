			...
			<Fragment>
				...
				>
					...
					>
						...
						This dashboard example was created using only the
						available elements and components, no additional SCSS
						was written!
					</Alert>
					<Row>
						<Col md='6' lg='3'>
												...
												<div className='widget-title ml-auto font-size-lg font-weight-normal text-muted'>
													<div className='ml-auto'>
														<Circle
															...
															showPercentage={
																true
															} // Boolean: Show/hide percentage.
															showPercentageSymbol={
																false
															} // Boolean: Show/hide only the "%" symbol.
														/>
													</div>
												</div>
											</div>
