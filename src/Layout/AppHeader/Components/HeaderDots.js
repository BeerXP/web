...
import IosAnalytics from "react-ionicons/lib/IosAnalyticsOutline";
								...
								<Row className="no-gutters">
									...
									<Col xl="4" sm="6">
										<Button
											...
											color="link"
										>
											<i className="pe-7s-hourglass icon-gradient bg-night-fade btn-icon-wrapper btn-icon-lg mb-3">
												{" "}
											</i>
											Activity
										</Button>
					...
					<UncontrolledDropdown>
						<DropdownToggle className="p-0" color="link">
							<div className="icon-wrapper icon-wrapper-alt rounded-circle">
								...
								<IosAnalytics color="#3ac47d" fontSize="23px" />
							</div>
						</DropdownToggle>
						<DropdownMenu
							right
						...
						>
							...
							<Nav vertical>
								<NavItem className="nav-item-divider mt-0">
									{" "}
								</NavItem>
								<NavItem className="nav-item-btn text-center">
									<Button
