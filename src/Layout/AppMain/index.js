						...
						<div className='loader-container-inner'>
							...
							<h6 className='mt-5'>
								...
								<small>
									...
									once all the Components examples. This
					...
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-5'>
								...
								<small>
									Because this is a demonstration we load at
									once all the Forms examples. This wouldn't
									happen in a real live app!
								</small>
							</h6>
						</div>
					</div>
					...
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-3'>
								...
								<small>
									Because this is a demonstration we load at
									once all the Charts examples. This wouldn't
									happen in a real live app!
								</small>
							</h6>
						</div>
					...
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-5'>
								...
								<small>
									Because this is a demonstration we load at
									once all the Tables examples. This wouldn't
									happen in a real live app!
								</small>
							</h6>
						</div>
					...
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-3'>
								...
								<small>
									Because this is a demonstration we load at
									once all the Elements examples. This
									wouldn't happen in a real live app!
								</small>
							</h6>
						</div>
					...
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-3'>
								...
								<small>
									Because this is a demonstration we load at
									once all the Dashboard Widgets examples.
					...
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-3'>
								...
								<small>
									Because this is a demonstration we load at
									once all the Pages examples. This wouldn't
									happen in a real live app!
								</small>
							</h6>
						</div>
				...
				fallback={
					<div className='loader-container'>
						<div className='loader-container-inner'>
							...
							<h6 className='mt-3'>
								Please wait while we load all the Applications
								examples
								<small>
									Because this is a demonstration we load at
									once all the Applications examples. This
									wouldn't happen in a real live app!
								</small>
							</h6>
						</div>
